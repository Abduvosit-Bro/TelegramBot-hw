...
#     in_button = types.InlineKeyboardButton('inline 1', callback_data='in_button')
#     in_button2 = types.InlineKeyboardButton('inline 2', callback_data='in_button2')
#
#     buttons.add(in_button, in_button2)
#
#     return buttons